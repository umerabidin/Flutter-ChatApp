            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  Align(alignment:Alignment.centerLeft ,child: BlocBuilder<LoginCubit, LoginState>(
                  ...
                  TextInputField(
                      ...
                      onChanged: (value) {
                        BlocProvider.of<LoginCubit>(context).isFormValid(_emailController.text.trim(), _passwordController.text.trim());
                      },
